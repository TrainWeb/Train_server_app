...
public class CommodityRecoderActivity extends AppCompatActivity {
    ...
    private void getSubmitedOrder() {
        ...
        if (TrainTravel.islogin) {
            ...
            ///////登陆
            startActivity(new Intent(CommodityRecoderActivity.this, LoginActivity.class));
        }
    ...
    private class FoodDetailAdapter extends RecyclerView.Adapter {
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
            ...
            mvHolder.tv_food_price.setText(df.format(Price));
    ...
    private class FoodViewHodeler extends RecyclerView.ViewHolder {
        ...
        final BootstrapButton order_confirm_bt;
        ...
        FoodViewHodeler(View itemView) {
            ...
            oeder_submit_id = (TextView) view.findViewById(R.id.oeder_submit_id);
            order_confirm_bt = (BootstrapButton) view.findViewById(R.id.order_confirm_bt);
        }
    }
}
