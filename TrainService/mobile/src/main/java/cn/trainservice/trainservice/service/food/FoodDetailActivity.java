...
public class FoodDetailActivity extends AppCompatActivity {
    ...
    private BootstrapButton order_submit_bt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView.setAdapter(new FoodDetailAdapter());
        order_submit_bt = (BootstrapButton) findViewById(R.id.order_submit_bt);
    ...
    private void submit_order() {
     ...
     private void error_progress(int code ,Map<Integer,List<String>> error){
    ...
    private class FoodDetailAdapter extends RecyclerView.Adapter {
        ...
        public void onBindViewHolder(ViewHolder holder, int position) {
            final String title = Commoditys.commoditys.get(position).getName();
            final String imgUrl = Commoditys.commoditys.get(position).getImg_url();
            final int number = Commoditys.commoditys.get(position).getNumber();

            final int sum_number = Commoditys.commoditys.get(position).getSum_number();
            final String comm_id = Commoditys.commoditys.get(position).getCommodity_id();
            float price = Commoditys.commoditys.get(position).getPrice();
            final int commodity_type = Commoditys.commoditys.get(position).getCommodity_type();
        ...
        public int getItemCount() {
            return Commoditys.getCommodetys();
        }
    }
